...
train <- read.csv("Data Set- PGP March 17.csv", stringsAsFactors = FALSE)
View(train)
...
# same across splits.
set.seed(54321)
indexes <- createDataPartition(train$Churn,times = 1,p = 0.7,list = FALSE)
...
confusionMatrix(preds, titanic.test$Churn)
